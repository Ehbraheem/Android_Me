...
public class BodyPartFragment extends Fragment {
    ...
    public static final String MLIST_OF_IMAGE = "listOfImages";
    public static final String MLIST_INDEX = "listIndex";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(MLIST_OF_IMAGE);
            mListIndex = savedInstanceState.getInt(MLIST_INDEX);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putIntegerArrayList(MLIST_OF_IMAGE, (ArrayList<Integer>) mImageIds);
        outState.putInt(MLIST_INDEX, mListIndex);
    }
}
